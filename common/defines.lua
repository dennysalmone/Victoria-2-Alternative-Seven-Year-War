...
country = {
	...
	CAMPAIGN_EVENT_BASE_TIME = 42, -- once every 4 weeks.
	...
	CAMPAIGN_DURATION = 4,	-- a campaign lasts these amount of months
	...
	NONCORE_TAX_PENALTY = -0.03, -- -5% for each non-core in state
	...
	MIN_DELAY_BETWEEN_REFORMS = 3, -- months
	...
	MAX_SUPPRESSION = 100,
	PRESTIGE_HIT_ON_BREAK_COUNTRY = -0.25, -- percentage reduction when country gets taken by rebels
	...
	COLONIZATION_DAYS_FOR_INITIAL_INVESTMENT = 550,
	...
	COLONIZATION_RELEASE_DOMINION_COST = 800,
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 120, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 1500000,
	MAX_LOAN_CAP_FROM_BANKS = 15, -- can loan max % of country tax base from single country
	...
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.80, -- % of how much we pay to the pops and capitalists, from the leftovers.
	MAX_FACTORY_MONEY_SAVE = 50000,	-- how much money is stored maximum in a factory.
	SMALL_DEBT_LIMIT = 50000,
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.65, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
military = {
	...
	AI_ARMY_TAXBASE_FRACTION = 0.6, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 0.35, -- max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
diplomacy = {
	...
	GOOD_PEACE_REFUSAL_MILITANCY = 0.5, --Militancy hit from refusing a good peace offer
	...
	CB_GENERATION_SPEED_BONUS_ON_COLONY_COMPETITION_TROOPS_PRESENCE = 2, -- even bigger bonus when having
	...
	CRISIS_DID_NOT_TAKE_SIDE_PRESTIGE_FACTOR_BASE = -0.2,
	...
	RANK_1_TENSION_DECAY = -0.35, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.25,
	RANK_3_TENSION_DECAY = -0.18,
	RANK_4_TENSION_DECAY = -0.12,
...
pops = {
	...
	NATIONAL_FOCUS_DIVIDER = 500000.0,
	...
	ARTISAN_MIN_PRODUCTIVITY = 0.50, -- Minimum efficiency of an artisan
	SLAVE_GROWTH_DIVISOR = 0.1, -- Slaves have N times lower growth
	
	MIL_HIT_FROM_CONQUEST = 5, -- how much militancy grows in a province if taken without being core.
	LUXURY_CON_CHANGE = 0.005, -- con boost from over-buying luxuary goods
	...
	LARGE_POPULATION_INFLUENCE_PENALTY_CHUNK = 3000000,
},
...
ai = {
	...
	ONE_SIDE_MAX_WARSCORE = 120, -- don't add too many wargoals to one side in a war
	POP_PROJECT_INVESTMENT_MAX_BUDGET_FACTOR = 0.25, -- how much % of our current budget can be spend on the pop project investments.
	RELATION_LIMIT_NO_ALLIANCE_OFFER = 25, -- if relation lower then this value, AI will not ally
	...
	CHANCE_FOREIGN_INVEST = 0.5,
	TWS_AWARENESS_SCORE_LOW_CAP = 0.3, -- AI will always add CBs if current warscore is less then that number (including TWS)
	TWS_AWARENESS_SCORE_ASPECT = 0.75, -- AI will not add any more CBs when TWS is more then X% of total WS. (to not destroy the progress)
	...
	MAX_FLEETS = 7, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
...
graphics =
{
	...
	CITIES_SIZE_MAX_POPULATION_K = 8000 			-- When province population reach 1mln, the city will get it's maximum size.
}
